  ...
  return (
    <div className='animate-fadeIn'>
      ...
      <div className='flex md:flex-row flex-col gap-y-5 flex-wrap justify-between items-center mx-8 my-6'>
        <div className='flex flex-col gap-y-4 w-[90%] md:w-[45%] items-center border border-none rounded-3xl bg-[#292928] py-3'>
          ...
          <div className='flex flex-col gap-y-2'>
            <button className='bg-violet-500 md:w-48 w-32 p-2 rounded-3xl font-bold'>
              <a href="">Live Link</a>
            </button>
            <button className='md:w-48 w-32 p-2 font-bold rounded-3xl bg-gray-700'>
